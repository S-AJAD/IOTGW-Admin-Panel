                        ...
                        <Col md={12}>
                            <Form horizontal>
                                <Card
                                    ...
                                    content={
                                        <div>
                                            ...
                                            <FormGroup controlId="formHorizontalNumber">
                                                ...
                                                <Col sm={6}>
                                                <FormControl type="text" name="type_type" onChange={(event) => {
                                                        this.setState({type_text: event.target.value});
                                                        event.target.value === "" ? this.setState({ type_textError: (<small className="text-danger">Type is required.</small>) }):this.setState({ type_textError: null });
                                                    }}/>
                                                </Col>
                                            </FormGroup>
                                            <FormGroup controlId="formHorizontalEmail">
                                    ...
                                    ftTextCenter
                                    legend={
                                        <Button fill bsStyle="info" type="submit" onClick={this.handleTypeValidation.bind(this)}>Add Device</Button>
                                    }
                                />
                            </Form>
                        </Col>
